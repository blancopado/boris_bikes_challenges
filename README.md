...
This is a command line program that will run all the docking stations, simulate all the bikes, and emulate all the infrastructure. The goal of this project is to practise OOD in Ruby.
